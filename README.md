...
## Introduction
This repository contains R scripts that analyze how high-intensity fires effect woody plant communities, specifically looking at understanding changes in mortality, woody plant traits, and changes in cover at Konza Prairie Biological Station in Manhattan, KS, USA. The first R script looks at change in stem densities using stem diameters and allometric data from woody plants on the ground.
